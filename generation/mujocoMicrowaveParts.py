...
def build_microwave(length, width, height, thicc, left, set_pose=None, set_rot=None):
    ...
    if set_pose is None:
        ...
        base_quat = tf3d.quaternions.qmult(base_quat_y, base_quat_z)
    else:
        base_xyz = set_pose
        base_quat = set_rot
...
def test():
    ...
    while t < 5000:
        ...
        # print("\nq: ", sim.data.qpos[0], " q_dot: ", sim.data.qvel[0], " q_ddot: ", sim.data.qacc[0],
        #       " \ntorque_applied: ", sim.data.qfrc_applied[0])
