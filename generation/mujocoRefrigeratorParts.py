...
def build_refrigerator(length, width, height, thicc, left, set_pose=None, set_rot=3.14):
    ...
    # build the doors
    HANDLE_X, HANDLE_Y, HANDLE_Z, HANDLE_LEN, HANDLE_WIDTH, HANDLE_HEIGHT = sample_fridge_handle(length, width,
    ...
    HANDLE_X2, HANDLE_Y2, HANDLE_Z2, HANDLE_LEN2, HANDLE_WIDTH2, HANDLE_HEIGHT2 = sample_fridge_handle(length, width,
                                                                                                       height * (
                                                                                                                   1 - height_fraction),
                                                                                                       1)
